                                ...
                                <li className='px-3 py-1 d-flex justify-center'>
                                    <ul className='d-flex gap-2 align-center'>
                                        ...
                                        {(user.role != "comercio" || titulo != "transacciones") && (admin == null || admin[0].permisos == 1) && (titulo == 'comercios' || titulo == 'admins' || titulo == 'transacciones' || titulo == 'comercios/pagos' || titulo == 'asociaciones' || titulo == 'clientes')
                                            ? console.log(user.role, user.role != "comercio", titulo != "transacciones", (admin == null || admin[0].permisos == 1), (titulo == 'comercios' || titulo == 'admins' || titulo == 'transacciones' || titulo == 'comercios/pagos' || titulo == 'asociaciones' || titulo == 'clientes'))
                                            // ? <li>
